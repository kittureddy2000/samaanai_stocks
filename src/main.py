...
class TradingAgent:
    ...
    def test_connections(self) -> bool:
        ...
        # Test Alpaca Trading
        if not self.trading_client.test_connection():
            return False
        
        # Test Alpaca Data + OpenAI
    ...
    def run_analysis_cycle(self):
        ...
        try:
            ...
            if not self.trading_client.is_market_open():
                market_hours = self.trading_client.get_market_hours()
...
def main():
    ...
    if args.portfolio:
        ...
        print(agent.risk_manager.format_risk_display(agent.trading_client.get_account()))
        sys.exit(0)
