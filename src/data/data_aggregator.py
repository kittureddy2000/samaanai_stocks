...
class DataAggregator:
    ...
    def get_stock_analysis(self, symbol: str, days: int = 60) -> Dict[str, Any]:
        ...
        try:
            ...
            tech_data = indicators.calculate_all()
            analysis['technical'] = tech_data
            
            # Generate summary signals
            analysis['signals'] = self._generate_signals(tech_data)
    ...
    def _generate_signals(self, tech_data: Dict[str, Any]) -> Dict[str, Any]:
