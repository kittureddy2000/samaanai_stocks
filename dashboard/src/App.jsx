...
import { getPortfolio, getRisk, getMarket, getWatchlist, getTrades, getConfig, getIndicators, getCurrentUser, getLoginUrl, getLogoutUrl } from './api';
import './App.css';
      ...
      <div className="dashboard">
        <div className="login-container">
          <div className="login-card">
            ...
            <p className="login-note">Access restricted to authorized users only</p>
          </div>
        </div>
      </div>
    );
